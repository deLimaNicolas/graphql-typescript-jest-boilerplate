...
var MapFields = /** @class */ (function () {
    function MapFields(fieldNodeTransformerMap) {
        this.transformer = new TransformObjectFields_1.default(function (_typeName, _fieldName, field) { return index_1.toConfig(field); }, function (typeName, fieldName, fieldNode, fragments) {
