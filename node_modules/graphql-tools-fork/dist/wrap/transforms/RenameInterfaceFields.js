...
var TransformInterfaceFields_1 = __importDefault(require("./TransformInterfaceFields"));
var RenameInterfaceFields = /** @class */ (function () {
    function RenameInterfaceFields(renamer) {
        this.transformer = new TransformInterfaceFields_1.default(function (typeName, fieldName, field) { return ({
