...
var TransformCompositeFields = /** @class */ (function () {
    ...
    TransformCompositeFields.prototype.transformSchema = function (originalSchema) {
        var _a;
        var _this = this;
        this.transformedSchema = index_1.mapSchema(originalSchema, (_a = {},
            _a[Interfaces_1.MapperKind.OBJECT_TYPE] = function (type) {
                return _this.transformFields(type, _this.fieldTransformer);
            },
            _a[Interfaces_1.MapperKind.INTERFACE_TYPE] = function (type) {
                return _this.transformFields(type, _this.fieldTransformer);
            },
            _a));
    ...
    TransformCompositeFields.prototype.transformFields = function (type, fieldTransformer) {
        var _this = this;
        var typeConfig = index_2.toConfig(type);
        ...
        if (graphql_1.isObjectType(type)) {
            return new graphql_1.GraphQLObjectType(__assign(__assign({}, index_2.toConfig(type)), { fields: newFields }));
        }
        else if (graphql_1.isInterfaceType(type)) {
            return new graphql_1.GraphQLInterfaceType(__assign(__assign({}, index_2.toConfig(type)), { fields: newFields }));
        }
    };
    TransformCompositeFields.prototype.transformDocument = function (document, mapping, fieldNodeTransformer, fragments) {
        ...
        var newDocument = graphql_1.visit(document, graphql_1.visitWithTypeInfo(typeInfo, {
            leave: (_a = {},
