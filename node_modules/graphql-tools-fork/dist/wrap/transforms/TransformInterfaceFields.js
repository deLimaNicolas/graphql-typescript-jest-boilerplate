...
var TransformCompositeFields_1 = __importDefault(require("./TransformCompositeFields"));
var TransformInterfaceFields = /** @class */ (function () {
    ...
    TransformInterfaceFields.prototype.transformSchema = function (originalSchema) {
        ...
        var compositeToObjectFieldTransformer = function (typeName, fieldName, field) {
            if (graphql_1.isInterfaceType(originalSchema.getType(typeName))) {
                return _this.interfaceFieldTransformer(typeName, fieldName, field);
            }
            return undefined;
        };
        this.transformer = new TransformCompositeFields_1.default(compositeToObjectFieldTransformer, this.fieldNodeTransformer);
