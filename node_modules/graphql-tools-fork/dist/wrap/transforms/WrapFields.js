...
var WrapFields = /** @class */ (function () {
        ...
        this.transformer = new MapFields_1.default((_a = {},
            _a[outerTypeName] = (_b = {},
                _b[outerMostWrappingFieldName] = function (fieldNode, fragments) {
                    return index_1.hoistFieldNodes({
                        fieldNode: fieldNode,
    ...
    WrapFields.prototype.transformSchema = function (schema) {
        ...
        var targetFields = index_1.removeFields(typeMap, this.outerTypeName, !this.fieldNames
        ...
        index_1.appendFields(typeMap, innerMostWrappingTypeName, targetFields);
        for (wrapIndex--; wrapIndex > -1; wrapIndex--) {
            index_1.appendFields(typeMap, this.wrappingTypeNames[wrapIndex], (_a = {},
                _a[this.wrappingFieldNames[wrapIndex + 1]] = {
                    type: typeMap[this.wrappingTypeNames[wrapIndex + 1]],
                    resolve: index_2.defaultMergedResolver,
                },
                _a));
        }
        index_1.appendFields(typeMap, this.outerTypeName, (_b = {},
            _b[this.wrappingFieldNames[0]] = {
                type: typeMap[this.wrappingTypeNames[0]],
                resolve: index_2.createMergedResolver({ dehoist: true }),
            },
            _b));
